...
* Склонируйте репозиторий на сервер и заполните .env файл с помощью шаблона [.env.sample](.env.sample)
...
* Склонируйте репозиторий и заполните .env файл с помощью шаблона [.env.sample](.env.sample) и 
...
* Склонируйте репозиторий и заполните .env файл с помощью шаблона [.env.sample](.env.sample) и затем в консоле введите
команду:
...
шаблон [.env.sample](.env.sample), запустите командой `python manage.py runserver`
